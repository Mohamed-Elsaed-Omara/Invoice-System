...
@section('content')
    ...
    @if (session()->has('restore_invoice'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم ازالة الفاتورة من الارشفة بنجاح",
                    type: "success"
                })
            }
        </script>
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('invoice-details/' . $invoice->id) }}">{{ $invoice->section->name }}</a>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" onclick="confirmation(event)"
                                                        href="{{ url('del-invoice-archive/' . $invoice->id) }}"> <i
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"> نقل ارشفة الفاتورة </h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ url('archive/' . $invoice->id) }}" method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                        هل انت متاكد من عملية النقل من الارشفة ؟
...
<script type="application/javascript">
	...
	function confirmation(ev){
		...
		ev.preventDefault();
			...
			swal({
				title: "هل انت متأكد من حذف الفاتورة نهائيا",
				icon: "warning",
				buttons: true,
				dangerMode: true,
