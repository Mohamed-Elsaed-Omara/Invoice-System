                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{ App\Models\invoice::where('status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    $count_invoices2 = App\Models\invoice::where('status', 2)->count();
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        $count_all= App\Models\invoice::count();
                                        $count_invoices1 = App\Models\invoice::where('status', 1)->count();
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(App\Models\invoice::where('status', 3)->sum('total'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ App\Models\invoice::where('status', 3)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
