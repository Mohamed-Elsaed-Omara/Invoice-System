    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url('/search-report') }}" method="POST" role="search" autocomplete="off">
                    @csrf
                    <div class="col-lg-3">
                        <label class="rdiobox">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                required>
                                <option selected @readonly(true) disabled>
                                    حدد نوع الفواتير
                                </option>

                                <option value="1" {{ old('type') == 1 ? 'selected' : '' }}>الفواتير المدفوعة</option>
                                <option value="2" {{ old('type') == 2 ? 'selected' : '' }}>الفواتير الغير مدفوعة</option>
                                <option value="3" {{ old('type') == 3 ? 'selected' : '' }}>الفواتير المدفوعة جزئيا</option>
