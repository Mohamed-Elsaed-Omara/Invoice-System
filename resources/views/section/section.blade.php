                            ...
                            <div class="modal-body">
                                <form action="{{ url('sections') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="InputSection" name="name">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-outline-info" data-effect="effect-scale"
                                                data-toggle="modal" href="#edit{{ $section->id }}">تعديل</a>
                                            
                                            <a class="btn btn-sm btn-outline-danger" onclick="confirmation(event)"
                                                href="{{ url('sections-del/' . $section->id) }}" >حذف</a>
                                        </td>
	...
	function confirmation(ev){
		...
		ev.preventDefault();
			...
			swal({
				...
				text: "عند حذف القسم لا يمكن الرجوع اليه مرة اخري!",
				icon: "warning",
				buttons: true,
				dangerMode: true,
